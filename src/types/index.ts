...
export type Editable<T extends Record<string, unknown>, K extends string> = { [P in K]: T[P] }
export type BooleanString = 'true' | 'false'
export type MappedRecord<K extends keyof T, T extends Record<K, unknown>> = { [P in K]: T[P] }
