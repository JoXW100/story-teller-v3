...
const PropertyMap: Record<keyof IProperties, React.ReactNode> = {
    ...
    strModifier: <LocalizedText id='editor-properties-strModifier' />,
    dexModifier: <LocalizedText id='editor-properties-dexModifier' />,
    conModifier: <LocalizedText id='editor-properties-conModifier' />,
    intModifier: <LocalizedText id='editor-properties-intModifier' />,
    wisModifier: <LocalizedText id='editor-properties-wisModifier' />,
    chaModifier: <LocalizedText id='editor-properties-chaModifier' />,
